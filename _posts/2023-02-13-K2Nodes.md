...
Your node has now been registered to the node list, and you should be able to find the node in any Blueprint graph.

## Populate the node with pins

Your node is now fully setup with title, category, tooltip, and you can find it in the node list. It should now look like this when you add it to the graph:
