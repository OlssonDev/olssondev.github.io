...
As you can see above, we have two versions of making an ExecPin, and both are valid in the sense that they work, but Version 1 is a better alternative. **UEdGraphSchema_K2** is a great class to get names of different pin types and should be used when choosing the pin's PinCategory.
