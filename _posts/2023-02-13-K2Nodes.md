...
Change the color of your node:

```javascript
virtual FLinearColor GetNodeTitleColor() const override
{
	//Now the node turns red.
	return FLinearColor::Red;
};
```

And now your node will change color!

![RedNode](https://raw.githubusercontent.com/OlssonDev/olssondev.github.io/master/assets/img/RedNode.JPG)
