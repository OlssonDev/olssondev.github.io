...
To add logic, we need to add the **ExpandNode** function that runs every time you compile your Blueprint to check for errors, spawn/remove nodes, generate Blueprint compiler errors, and much more.
