...
I really recommend doing this for any pins with custom names, it makes your life much easier making custom nodes, especially when you're using **UEdGraphNode::FindPin**.
...
When all this is added and you compile. Your node should look like this:
...
Your node is now fully completed visually, but it can't do anything and generates compiler errors. 
