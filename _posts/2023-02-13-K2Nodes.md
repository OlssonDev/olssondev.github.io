...
{: .box-note}
**Note:** If you want to expose functions from C++ to Blueprint, this post is way too overkill. You should check out [this](https://docs.unrealengine.com/4.27/en-US/ProgrammingAndScripting/Blueprints/TechnicalGuide/ExtendingBlueprints/) resource instead.
...
//Set the icon and the icon tint of the node.
